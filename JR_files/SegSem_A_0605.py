...
model.load_state_dict(torch.load('C:/Bloodcells/Modele/Data/ALL_IDB2/ALL_IDB2/img_modified/img_modified/Pytorch0605_median.pth'))
...
image_filenames = glob.glob('C:/Bloodcells/Modele/Data/ALL_IDB2/ALL_IDB2/img_modified/img_modified/Images/*.png')
label_filenames = glob.glob('C:/Bloodcells/Modele/Data/ALL_IDB2/ALL_IDB2/img_modified/img_modified/Label/*.png')
#classNames = ["background","Basophile",'BNE_SNE_NE','EOSINOPHIL',
#'ERYTHROBLASTE','IG_MY_MMY_PMY','MONOCYTE','LYMPHOCYTE','SMUDGE'];


class TransformLabels:
    def __call__(self, label):
        label[label == 0] = 0 #Background
        label[label == 50] = 1 #Normal
        label[label == 150] = 2 #Smudge
        label[label == 250] = 3 #Blaste
...
torch.save(model.state_dict(), 'C:/Bloodcells/Modele/Data/ALL_IDB2/ALL_IDB2/img_modified/img_modified/Pytorch0605_median.pth')
